# specZfind: A tool for finding the redshift and classifing any cosmic source from its spectra.

In this project, we built a python package for finding the redshift of any astronomical source and  given their spectra. We implemented it on the SDSS datasets and further extended it to classify extragalactic sources present in the SDSS spectra.
