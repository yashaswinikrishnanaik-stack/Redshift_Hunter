...
def find_redshift(obs_wave, obs_flux, tmpl_wave, tmpl_flux,
    ...
    return z
obs_spectra = observed_spectra("spec-1678-53433-0425.fits")[1]
obs_wave = observed_spectra("spec-1678-53433-0425.fits")[0]
eig_spectra = Eigenspectra("spEigenGal-53054.fits")[1]
eig_wave = Eigenspectra("spEigenGal-53054.fits")[0]

print(find_redshift(obs_wave, obs_spectra, eig_wave, eig_spectra,
                   z_min=-0.01, z_max=1.0, dloglam=1e-4, min_overlap=50))
